...
?> 
    ...
    <div class="rts-banner-area rts-section-gap rts-breadcrumb-area  position-relative water-bd">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-area-inner">
                        ...
                        <div class="nav-area-navigation">
                            ...
                            <a class="current" href="water.php">Water Auditing</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-5">
                    <div class="thumbnail-main-wrapper-2">
                        <div class="reveal-item overflow-hidden aos-init">
                            ...
                            <img src="assets/images/about/3.png" alt="journey-area">
                        </div>
                    </div>
                </div>
                <div class="col-xl-7 pl--60 pl_md--0 pl_sm--10 pt_md--30 pt_sm--30">
                    <div class="about-content-area-two">
                        <div class="title-style-two-left">
                            <h2 class="title">Water Auditing</h2>
