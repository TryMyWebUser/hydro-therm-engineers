                        ...
                        <div class="footer-wrapper-right">
                            <div class="single-nav-area-footer use-link">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="products.php"><i class="fa-regular fa-arrow-right-long"></i>Our Products</a>
                                    </li>
                                    <li>
                                        <a href="services.php"><i class="fa-regular fa-arrow-right-long"></i>Our Services</a>
                                    </li>
                                    <li>
                                ...
                                <div class="col-lg-12">
                                    <div class="copyright-wrapper">
                                        <p class="mb-0">
                                            ...
                                            Design and Developed By <a href="https://trymywebsites.com/">Trymywebsiets</a>
                                        </p>
                                        <!-- <div class="right-nav">
                                            <ul>
