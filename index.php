                        ...
                        <div class="header-main-wrapper">
                            <div class="logo-area">
                                <a href="index.html" class="logo">
                                    ...
                                    <h5 class="m-0">Hydro Therm Engineers</h5>
                                </a>
                            </div>
                            <!-- header right start -->
                            <div class="rts-header-right position-static">
                                    ...
                                    <div class="start-top">
                                        <div class="social-header">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="https://wa.me/+919600401004"><i class="fa-brands fa-whatsapp"></i></a>
                                                </li>
                                                <li>
                                ...
                                <div class="bottom">
                                                ...
                                                <ul class="submenu menu-home">
                                                    ...
                                                    <li class="coming-soon">
                                                        ...
                                                        <ul class="page">
                                                            ...
                                                            <li class="onepage"><a class="rts-btn btn-primary" href="#">Coming Soon</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                                                                            ...
                                                                            <a href="service-single.html">
                                                                                <div class="single-service-menu">
                                                                                    ...
                                                                                    <div class="info">
                                                                                        ...
                                                                                        <p class="details">
                                                                                            Once planning is complete, site preparation begins. This phase involves clearing...
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                            ...
                                                                            <a href="service-single-three.html">
                                                                                <div class="single-service-menu">
                                                                                    ...
                                                                                    <div class="info">
                                                                                        ...
                                                                                        <p class="details">
                                                                                            Elever Architecture is a New-York-based studio on modern design, interiors and landscapes...
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                            ...
                                                                            <a href="contact.html" class="free-consultation">
                                                                                <div class="single-service-menu">
                                                                                    <div class="info">
                                                                                        ...
                                                                                        <p class="details">
                                                                                            From preconstruction to virtual design and construction, we offer virtual design construction.
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                            ...
                                                            <div class="row g-0">
                                                                <div class="col-lg-3">
                                                                    <ul class="mega-menu-item with-list parent-nav">
                                                                        ...
                                                                        <li>
                                                                            <a href="company-history.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Company History</a>
                                                                        </li>

                                                                        <li>
                                                                            <a href="company-story.html"><i class="fa-sharp fa-regular fa-chevron-right"></i> Company History 2</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="company-values.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Company Values</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="our-office.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Our Office</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="working-process.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Working Process</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="working-process-2.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Working Process 2</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <ul class="mega-menu-item with-list parent-nav">
                                                                        <li>
                                                                            <a href="safety.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Safety</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="pricing.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Pricing Plan</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="pricing-2.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Pricing Plan 2</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="vision.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Vision</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="careers.html"><i class="fa-sharp fa-regular fa-chevron-right"></i> Career</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="sustainability.html"><i class="fa-sharp fa-regular fa-chevron-right"></i> Sustainability</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="gallery.html"><i class="fa-sharp fa-regular fa-chevron-right"></i> Company Gallery</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <ul class="mega-menu-item with-list parent-nav">
                                                                        <li>
                                                                            <a href="our-clients.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Our Clients</a>
                                                                        </li>
                                                                        <li>
                                                                        ...
                                                                        <li>
                                                                            <a href="team.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Our Team</a>
                                                                        </li>
                                                                        <li>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <ul class="mega-menu-item with-list parent-nav">
                                                                        ...
                                                                        <li>
                                                                            <a href="appoinment.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Appointment</a>
                                                                        </li>
                                                                        <li>
                                                                        ...
                                                                        <li>
                                                                            <a href="privacy-policy.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Privacy Policy</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="terms-of-condition.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Terms & Condition</a>
                                                                        </li>
                                                                        <li>
                                                            ...
                                                            <div class="row g-0">
                                                                <div class="col-lg-3">
                                                                    <ul class="mega-menu-item with-list parent-nav">
                                                                        ...
                                                                        <li>
                                                                            <a href="project-slider-3.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Slider 3</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-list.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project List</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-card.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Card</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <ul class="mega-menu-item with-list parent-nav">
                                                                        ...
                                                                        <li>
                                                                            <a href="project-two-column.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project 2 Columns</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-three-column.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project 3 Columns</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-two-column-wide.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project 2 Columns Wide</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-three-column-wide.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project 3 Columns Wide</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-four-column.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project 4 Columns </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-four-column-wide.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project 4 Columns Wide </a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <ul class="mega-menu-item with-list parent-nav">
                                                                        ...
                                                                        <li>
                                                                            <a href="project-hide-content-col-3.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Hide Content</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-hide-content.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Hide Content wide</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-card-hover.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Card Hover</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-zoom-slider.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Slider Image Zoom</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-hide-show.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Hide Show</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="project-slider-hover.html"><i class="fa-sharp fa-regular fa-chevron-right"></i>Project Slider Hover</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-lg-3">
                                    ...
                                    <div class="right-area">
                                        <a href="https://wa.me/+919600401004" class="rts-btn btn-header btn-transparent">
                                            Get a Quote
                    ...
                    <ul class="mainmenu metismenu" id="mobile-menu-active">
                        ...
                        <li class="has-droupdown">
                            ...
                            <ul class="submenu mm-collapse">
                                ...
                                <li><a href="company-values.html">Company Values</a></li>
...
>>>>>>> 390ed05 (developer commit)
        ...
        <div class="banner-swiper-area-one">
            <div class="swiper mySwiper-banner-one" dir="ltr">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <!-- banner area one start -->
                        <div class="banner-area-one-start rts-section-gap bg_banner-one bg_image">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <!-- banner inner content area -->
                                        <div class="banner-inner-content-one">
                                            <span class="pre">Building The Better Future</span>
                                            <h1 class="title">Build Your Dream Project with Us Today!</h1>
                                            <p class="disc">
                                            ...
                                            <div class="button-wrapper">
                                                <a href="#" class="rts-btn btn-white">Our Services <img src="assets/images/icons/arrow-up-right-1.svg" alt="arrow" /></a>
                                            </div>
                                        </div>
                    ...
                    <div class="swiper-slide">
                        <!-- banner area one start -->
                        <div class="banner-area-one-start rts-section-gap two bg_banner-one bg_image">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <!-- banner inner content area -->
                                        <div class="banner-inner-content-one">
                                            <span class="pre">Building The Better Future</span>
                                            <h1 class="title">Let Us Help You Build Extraordinary!</h1>
                                            <p class="disc">
                                                We are dedicated to building structures that last and relationships that endure, With a focus on quality, precision, and innovation, we provide a full range of construction services.
                                            </p>
                                            <div class="button-wrapper">
                    ...
                    <div class="swiper-slide">
                        <!-- banner area one start -->
                        <div class="banner-area-one-start rts-section-gap three bg_banner-one bg_image">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <!-- banner inner content area -->
                                        <div class="banner-inner-content-one">
                                            <span class="pre">Building The Better Future</span>
                                            <h1 class="title">Start Building Your Project Today!</h1>
                                            <p class="disc">
                                                We are dedicated to building structures that last and relationships that endure, With a focus on quality, precision, and innovation, we provide a full range of construction services.
                                            </p>
                                            <div class="button-wrapper">
        ...
        <div class="fun-facts-area rts-section-gap">
            <div class="container">
                <div class="row g-24">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="single-fun-facts-area">
                            <div class="icons">
                                <img src="assets/images/service/icons/07.svg" alt="service" />
                            </div>
                            <h2 class="counter title"><span class="odometer" data-count="1998">00</span>+ Since</h2>
                            <p class="disc">
                                A pioneer of water treatment in India our company was established in 1998 at Coimbatore.
                            </p>
                        </div>
                    </div>
                    <!-- <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="single-fun-facts-area">
                            ...
                            <h2 class="counter title"><span class="odometer" data-count="85">00</span>%</h2>
                            <p class="disc">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 pl--80 pl_md--15 pl_sm--10 pt_md--25 mt_sm--25">
                            <div class="about-inner-area-content-one">
                                ...
                                <p class="disc">
                                    A pioneer of water treatment in India our company was established in 1998 at Coimbatore. We are engaged in production, sales and service of water & wastewater treatment system. The company is promoted by a group of technocrats, devoted to excellence in the field of drinking water treatment and wastewater management with a wide and varied experience. We have successfully executed countless projects for various clients in different segments of industry. Our diversified business include DM PLANT (De-Minerlaisation), R.O.System, UF (Ultra Filtration), (NF) Nano Filtration, Ozonator, ETP (Effluent Treatment Plant),  STP (Sewage Treatment Plant) and packaged drinking water plant.
                                </p>
                                <a href="about.html" class="rts-btn btn-primary border">Explore More <img src="assets/images/icons/arrow-up-right-2.svg" alt="service" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-full" dir="ltr">
                <div class="marque-wrapper one">
                    <div class="marquee">
                        <span>Premium Construction Theme&nbsp;</span>
                        <span>Premium Construction Theme&nbsp;</span>
                        <span>Premium Construction Theme&nbsp;</span>
                        <span>Premium Construction Theme&nbsp;</span>
                        <span>Premium Construction Theme&nbsp;</span>
                    ...
                    <div class="row rts-section-gapTop">
                        <div class="col-lg-12">
                            <div class="title-center-style-one">
                                <span class="pre">Area of </span>
                                <h2 class="title">Expertise</h2>
                            </div>
                        </div>
                        <div class="col-lg-12 mt--40">
                            <div class="swiper-area-wrapper" dir="ltr">
                                <div class="swiper mySwiper-service-one">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="single-service-one">
                                                <span class="water-mark">01.</span>
                                                <div class="icon">
                                                    <img src="assets/images/service/01.png" alt="service" />
                                                </div>
                                                <div class="inner">
                                                    <h5 class="title">Operator Training</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-service-one">
                                                <span class="water-mark">02.</span>
                                                <div class="icon">
                                                    <img src="assets/images/service/02.png" alt="service" />
                                                </div>
                                                <div class="inner">
                                                    <h5 class="title">Project Consultancy</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-service-one">
                                                <span class="water-mark">03.</span>
                                                <div class="icon">
                                                    <img src="assets/images/service/03.png" alt="service" />
                                                </div>
                                                <div class="inner">
                                                    <h5 class="title">Erection Commissioning</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-service-one">
                                                <span class="water-mark">04.</span>
                                                <div class="icon">
                                                    <img src="assets/images/service/04.png" alt="service" />
                                                </div>
                                                <div class="inner">
                                                    <h5 class="title">Development & Maintainance</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-service-one">
                                                <span class="water-mark">05.</span>
                                                <div class="icon">
                                                    <img src="assets/images/service/05.png" alt="service" />
                                                </div>
                                                <div class="inner">
                                                    <h5 class="title">STP, WTP & ETP</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="single-service-one">
                                                <span class="water-mark">06.</span>
                                                <div class="icon">
                                                    <img src="assets/images/service/06.png" alt="service" />
                                                </div>
                                                <div class="inner">
                                                    <h5 class="title">Process Design</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="portfolio-team-area-bg rts-section-gap bg_image bg-dark">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-center-style-one">
                            <span class="pre">Recent Images</span>
                ...
                <div class="row g-24 mt--30 mt_sm--10">
                    <div class="col-lg-12">
                        <div class="swiper-silder-testimonials-wrapper">
                            <div class="swiper mySwiper-testimonails" dir="ltr">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="single-testimonials-area-one">
                                            <p class="disc">
                                                “From the initial consultation to the final walk-through, every step was handled with the utmost professionalism and care. Their team listened closely to our needs and created a plan that fit
                                                our vision perfectly, all while keeping us within budget and on schedule.”
                                            </p>
                                            <div class="bottom-area">
                                                <div class="user">
                                                    <img src="assets/images/testimonials/01.webp" alt="img" />
                                                    <div class="info">
                                                        <h5 class="title">Sophia Anne Harris</h5>
                                                        <span>Property Manager at Green Valley Realty</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-testimonials-area-one">
                                            <p class="disc">
                                                "The team’s commitment to quality and timely delivery was impressive. The end result exceeded our expectations and left our clients thrilled with their new space. Elever provided exceptional
                                                guidance and craftsmanship, creating a building we are proud to call ours.
                                            </p>
                                            <div class="bottom-area">
                                                <div class="user">
                                                    <img src="assets/images/testimonials/02.webp" alt="img" />
                                                    <div class="info">
                                                        <h5 class="title">Alena Joe Harris</h5>
                                                        <span>Property Manager at Green Valley Realty</span>
                                                    </div>
                                                </div>
                                                <div class="stars-area">
                    ...
                    <div class="col-lg-12">
                        <div class="contact-area-footer-top">
                            ...
                            <div class="single-contact-area-box">
                                ...
                                <a href="https://maps.app.goo.gl/XnmtipUMbVdeQN7ZA">
                                32A/42, Sri Nagar, Hope College, Peelamedu, Coimbatore - 641 004
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer-wrapper-left-one">
                            ...
                            <p class="disc">
                            A pioneer of water treatment in India our company was established in 1998 at Coimbatore. We are engaged in production, sales and service of water & wastewater treatment system.
                            </p>
                    ...
                    <div class="col-lg-8">
                        <div class="footer-wrapper-right">
                            <div class="single-nav-area-footer use-link">
                                ...
                                <ul>
                                    <li>
                                        <a href="index.php"><i class="fa-regular fa-arrow-right-long"></i>Home</a>
                                    </li>
                                    <li>
                                        <a href="about.php"><i class="fa-regular fa-arrow-right-long"></i>About Us</a>
                                    </li>
                                    <li>
                                        <a href="service.php"><i class="fa-regular fa-arrow-right-long"></i>Our Services</a>
                                    </li>
                                    <li>
                                        <a href="gallery.php"><i class="fa-regular fa-arrow-right-long"></i>Our Gallery</a>
                                    </li>
                                    <li>
                                        <a href="contact.php"><i class="fa-regular fa-arrow-right-long"></i>Contact Us</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="single-nav-area-footer use-link">
                                <h4 class="title">Quick Services (TODO)</h4>
                                <ul>
                                    <li>
                                        <a href="service.html"><i class="fa-regular fa-arrow-right-long"></i>General Contracting</a>
                                    </li>
                                    <li>
                                        <a href="service.html"><i class="fa-regular fa-arrow-right-long"></i>Project Management</a>
                                    </li>
                                    <li>
                                        <a href="service.html"><i class="fa-regular fa-arrow-right-long"></i>New Construction</a>
                                    </li>
                                    <li>
                                        <a href="service.html"><i class="fa-regular fa-arrow-right-long"></i>Renovations & Remodeling</a>
                                    </li>
                                    <li>
                                        <a href="service.html"><i class="fa-regular fa-arrow-right-long"></i>Interior Finishing</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="single-nav-area-footer use-link">
                                ...
                                <div>
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2414.6810951780226!2d77.01735845972608!3d11.024589592946489!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba85785aaf332ff%3A0xaf7e12ea8f7ceab8!2sHydro%20Therm%20Engineers!5e1!3m2!1sen!2sin!4v1741841512901!5m2!1sen!2sin" width="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="copyright-wrapper">
                                        <p class="mb-0">
                                            ...
                                            Design and Development By <a href="https://trymywebsites.com/">Trymywebsiets</a>
                                        </p>
                                        <!-- <div class="right-nav">
                                            <ul>
